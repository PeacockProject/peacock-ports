#!/bin/sh
# Debian hostname stage. On Debian the hostname lives in TWO places: /etc/hostname, and a 127.0.1.1
# line in /etc/hosts. The second one is the Debian convention and it is not cosmetic — with no entry
